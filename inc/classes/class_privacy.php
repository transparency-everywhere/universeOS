        		...
        		<ul>
        				...
        				<ul class="groupList">
        					                           <?
                                                        ...
                                                        while($attData = mysql_fetch_array($attSql)){
                                                            ...
                                                            ?>
                                                                <li>
                                                                	<div><img src="./gfx/icons/group.png" height="15">&nbsp;<a href="#" onclick="reader.tabs.addTab('<?=$title10;?>', '',browser.loadPage('group.php?id=<?=$groupData['id'];?>'));return false"><?=$title15;?></a></div>
                                                                	<div>
					...
					<li style="padding-left: 10px;"><input type="checkbox" name="privacyCustomSee[]" value="f" class="privacyCustomTrigger uncheckPublic uncheckHidden" <?=$checked[privacyCustomShowF];?> <?=$disabled;?>> All your Friends</li>
                                                        ...
                                                        while($attData = mysql_fetch_array($attSql)){
                                                            ...
                                                            ?>
                                                            <li style="padding-left:10px;"><input type="checkbox" name="privacyCustomSee[]" value="<?=$groupData[id];?>" class="privacyCustomTrigger uncheckPublic uncheckHidden" <?=$checked[showGroup];?> <?=$disabled;?>><img src="./gfx/icons/group.png" height="15">&nbsp;<a href="#" onclick="reader.tabs.addTab('<?=$title10;?>', '',browser.loadPage('group.php?id=<?=$groupData['id'];?>'));return false"><?=$title15;?></a></li>
                     ...
                     <li style="padding-left:5px;"><input type="checkbox" name="privacyCustomEdit[]" value="f" class="privacyCustomTrigger uncheckPublic uncheckOnlyMe uncheckHidden"<?=$checked[privacyCustomEditF];?> <?=$disabled;?>>All your Friends</li>
                                                        ...
                                                        while($attData = mysql_fetch_array($attSql)){
                                                            ...
                                                            ?>
                                                                <li style="padding-left:10px;"><input type="checkbox" name="privacyCustomEdit[]" value="<?=$groupData[id];?>" class="privacyCustomTrigger uncheckOnlyMe uncheckPublic uncheckHidden" <?=$checked[editGroup];?> <?=$disabled;?>><img src="./gfx/icons/group.png" height="15">&nbsp;<a href="#" onclick="reader.tabs.addTab('<?=$title10;?>', '',browser.loadPage('group.php?id=<?=$groupData['id'];?>')); return false"><?=$title15;?></a></li>
                                                        <?}
                                                        if($i < 1){
                                                            echo'<li style="padding-left:10px;">Your are in no group</li>';
                                                        }?>
