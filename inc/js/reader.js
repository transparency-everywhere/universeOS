    ...
    this.generateStartpage = function(){
        ...
        if(proofLogin()){
            html += '<div class="readerStartpage">';
                html += '<div class="welcomearea"><div class="userPicture"><img src="' + getUserPicture(User.userid) + '"></div><div class="welcomeText">Hidiho, '+ useridToUsername(User.userid) +',<br />good to see you!</div>';
                html += '<div class="navi">';
                    html += '<ul>';
