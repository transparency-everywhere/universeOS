<div id="registration">
	...
	<ul>
		...
		<li style="text-align:left; height: auto;"><input type="checkbox" class="checkRegBox">I accept the <a href="http://wiki.universeos.org/index.php?title=Policy" target="blank">terms</a>.</li>
